...
A production-ready Retrieval-Augmented Generation (RAG) chatbot API built with FastAPI and LangChain.
...
├── ⚙️ langchain_utils.py     # LangChain configuration
...
- 🗑️ `DELETE /documents/{doc_id}`: Remove documents
...
- `langchain_utils.py`: ⚙️ LangChain setup
- `pydantic_models.py`: 📐 Data models
